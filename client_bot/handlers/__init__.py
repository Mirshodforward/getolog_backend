...
def register_all_handlers(dp, bot, owner_id: int, bot_username: str, bot_token: str, bot_db_id: int):
    """Register all handlers to dispatcher"""
    register_start_handlers(dp, bot, owner_id, bot_username, bot_token, bot_db_id)
